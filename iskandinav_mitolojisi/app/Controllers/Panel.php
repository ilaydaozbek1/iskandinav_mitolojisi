...
protected $helpers=['form'];
    ...
    public function kayit_düzenle($id)
    {
        $session = session();
        ...
        if($session->has('durum') && $session->get('durum'))
        {
            ...
            $veri = $this->validator->getValidated();
            $sonuc = $model->veri_düzenle($veri['baslik'],url_title($veri['baslik'],'_',true),$veri['icerik'],$id);

            if($sonuc)
            {
                return redirect()->to(base_url('kayit_düzenle/'.$id));
            }
